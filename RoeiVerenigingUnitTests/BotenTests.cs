...
public class BotenTests
{
    ...
    public void Create_WithAdminRole_CreatesBoat()
    {
        ...
        // Assert
        _mockBoatRepository.Verify(
            r => r.Create(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<bool>(), It.IsAny<int>()),
            Times.Once);
    }
    ...
    {
        // Arrange
        var member = new Member(1, "tygo", "van", "olst", "tygo@mail.nl", new List<string> { "materiaal_commissaris" },
            10);
    ...
    public void Create_WithoutRequiredRole_ThrowsException()
    {
        ...
        Assert.Throws<IncorrectRightsException>(() =>
            _boatService.Create(member, "Test Boat", "Test Description", 5, true, 1));
        _mockBoatRepository.Verify(
            r => r.Create(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<bool>(), It.IsAny<int>()),
            Times.Never);
    }
