...
public class DamageTests
{
    ...
    public void GetAll_ReturnsAllDamageReports()
    {
        ...
        {
            new(1, new Member(1, "John", "", "Doe", "john.doe@example.com", new List<string>(), 1),
                new Boat(1, true, 4, 1, "Anna"), "description1", false, true),
            new(2, new Member(2, "Jane", "", "Doe", "jane.doe@example.com", new List<string>(), 1),
    ...
    public void GetRelatedToUser_ReturnsDamageReports_WhenItemsAreFound()
    {
        ...
        var damageReports = new List<Damage>
        {
            new(1, member,
                new Boat(1, true, 4, 1, "Anna"), "description1", false, true),
            new(2, member, new Boat(2, false, 2, 1, "Anna"), "description2", true, false)
        };
