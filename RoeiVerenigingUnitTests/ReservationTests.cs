...
public class ReservationTests
{
    ...
    public void ReservationSuccesfull()
    {
        ...
        var reservation = new Reservation(member, 4, new DateTime(2024, 5, 27, 14, 0, 0),
            new DateTime(2024, 5, 27, 16, 0, 0));
        ...
        //Act
        var result = ReservationService.Create(member, 4, new DateTime(2024, 5, 27, 14, 0, 0),
            new DateTime(2024, 5, 27, 16, 0, 0));
        //Assert
    ...
    public void TimeChecker_BothTimesValidAndStartBeforeEnd_ReturnsTrue()
    {
        ...
        // Act
        var result = checker.TimeChecker(start, end);
