...
using AddReservation = RoeiVerenigingWPF.Pages.member.AddReservation;
using DamageOverview = RoeiVerenigingWPF.Pages.member.DamageOverview;
using ViewReservations = RoeiVerenigingWPF.Pages.member.ViewReservations;
...
public partial class Buttons : UserControl
{
    ...
    private void ChangeColorOfRectangle(Grid rectangle)
    {
        ...
        switch (rectangle)
        {
            case not null when rectangle == BoatRectangle:
                ...
                break;
            case not null when rectangle == DamageRectangle:
                BoatRectangle.Visibility = Visibility.Hidden;
                DamageRectangle.Visibility = Visibility.Visible;
                EventsRectangle.Visibility = Visibility.Hidden;
                ReservationRectangle.Visibility = Visibility.Hidden;
                break;
            case not null when rectangle == EventsRectangle:
                BoatRectangle.Visibility = Visibility.Hidden;
                DamageRectangle.Visibility = Visibility.Hidden;
                EventsRectangle.Visibility = Visibility.Visible;
                ReservationRectangle.Visibility = Visibility.Hidden;
                break;
            case not null when rectangle == ReservationRectangle:
                BoatRectangle.Visibility = Visibility.Hidden;
                DamageRectangle.Visibility = Visibility.Hidden;
                EventsRectangle.Visibility = Visibility.Hidden;
