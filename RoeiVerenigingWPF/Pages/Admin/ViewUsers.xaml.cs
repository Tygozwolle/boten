...
public partial class ViewUsers : Page
{
    ...
    private readonly List<RoeiVerenigingLibrary.Model.Member> _memberList;
    ...
    public RoeiVerenigingLibrary.Model.Member SelectedMember { get; set; }

    public void PopulateUserList(List<RoeiVerenigingLibrary.Model.Member> memberList)
    {
        UserStackPanel.Children.Clear();
        for (int i = 0; i < memberList.Count; i++)
        {
            RoeiVerenigingLibrary.Model.Member member = memberList[i];
            Grid grid = new Grid();
            ...
            border.PreviewMouseLeftButtonDown += (sender, e) =>
            {
                ...
                {
                    RoeiVerenigingLibrary.Model.Member clickedUser = _memberList[UserStackPanel.Children.IndexOf((UIElement)sender)];
    ...
    private void ButtonFilterUsers(object sender, RoutedEventArgs e)
    {
        ...
        var selectedMemberList = new List<RoeiVerenigingLibrary.Model.Member>();
    ...
    public void TextFilterUsers(object sender, RoutedEventArgs e)
    {
        ...
        if (selectedTextbox != null)
        {
            ...
            {
                PopulateUserList(new List<RoeiVerenigingLibrary.Model.Member>());
            }
        }
    }
